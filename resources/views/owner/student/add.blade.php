            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body form-body">
                        ...
                        <form action="{{ route('owner-store-student') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="number" name="security_amount" value="{{ old('security_amount') }}" class="form-control"
                                        id="security_amount" placeholder="Security Amount" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="text" name="mother_name" value="{{ old('mother_name') }}"
                                        class="form-control" id="mother_name" placeholder="Enter Mother Name" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-4">
                                <label for="dob" class="form-label fw-bold">Date of Birth <sup
                                        class="text-danger">*</sup></label>
                                <div class="input-group has-validation">
                                    <span class="input-group-text" id="inputGroupPrepend"><i
                                            class="bx bxs-calendar"></i></span>
                            ...
                            <div class="col-12 col-lg-4">
                                <label for="aadhar_no" class="form-label fw-bold">Aadhar Number <sup
                                        class="text-danger">*</sup></label>
                                <div class="input-group has-validation">
                                    <span class="input-group-text" id="inputGroupPrepend"><i
                                            class="bi bi-cash"></i></span>
                            ...
                            <div class="col-12 col-lg-4">
                                <label for="aadhar_front" class="form-label fw-bold">Aadhar Front Image <sup
                                        class="text-danger">*</sup></label>
                                <div class="input-group has-validation">
                                    <span class="input-group-text" id="inputGroupPrepend"><i
                                            class="bi bi-cash"></i></span>
                                    <input type="file" name="aadhar_front" class="form-control" id="aadhar_front" required>
                                </div>
                            </div>

                            <div class="col-12 col-lg-4">
                                <label for="aadhar_back" class="form-label fw-bold">Aadhar Back Image <sup
                                        class="text-danger">*</sup></label>
                                <div class="input-group has-validation">
                                    <span class="input-group-text" id="inputGroupPrepend"><i
                                            class="bi bi-cash"></i></span>
                                    <input type="file" name="aadhar_back" class="form-control" id="aadhar_back" required>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hostel_id').on('change', function() {
                ...
                $('#room_id').html('');
                $.ajax({
                    url: '{{ route("owner-get-room") }}?id=' + hostel_id,
                    type: 'get',
                    success: function(res) {
                        if (res.length > 0) {
                            ...
                            $('#lock_in_period_date').val(res[0].lock_in_period);
                        } else {
                            $('#room_id').html(
            ...
            $('#room_id').on('change', function() {
                ...
                $('#bed_id').html('');
                $.ajax({
                    url: '{{ route("owner-get-bed") }}?id=' + room_id,
                    type: 'get',
                    success: function(res) {
                        if (res) {
                            $('#bed_id').html(
