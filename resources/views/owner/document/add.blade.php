...
@section('main-section')
    <div class="pagetitle position-relative">
        ...
        <div class="position-absolute top-0 end-0">
            <a href="{{ route('owner-profile') }}" class="btn btn-sm btn-outline-dark">Profile</a>
        </div>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body form-body">
                        ...
                        <div class="pt-4 pb-2">
                            <h5 class="card-title text-center pb-0 fs-4">Add Your Documents Below</h5>
                        </div>

                        <form action="{{ route('owner-store-document') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <fieldset>
                                ...
                                <div id="fieldsContainer">
                                    <div class="row fields-row mb-4">
                                        ...
                                        <div class="col-12 col-lg-3 mb-3 position-relative d-grid align-content-end">
                                            <button type="button"
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-lg-3">
                                        <button type="button" class="btn btn-outline-success w-100" id="addMoreBtn">Add
                                            More</button>
                                    </div>
                                </div>
                            </fieldset>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body form-body">
                            ...
                            <div class="pt-4 pb-2">
                                <h5 class="card-title text-center pb-0 fs-4">Edit Your Documents Below</h5>
                            </div>

                            @foreach ($documents as $document)
                                <form action="{{ route('owner-update-document', ['id' => $document->id]) }}" method="POST"
    ...
    <script>
        $(document).ready(function() {
            $('#addMoreBtn').click(function() {
                ...
                newFieldsGroup.find('input[type="text"], input[type="file"]').val(''); // Clear input values
