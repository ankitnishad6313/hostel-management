                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-3 justify-content-between align-items-center mb-3">
                            ...
                            <div>
                                <a href="{{ route('owner-create-room', ['id' => $data['hostel']->id]) }}" class="me-3"><button type="button"
                                        class="btn btn-outline-primary"><i class="bi bi-star me-1"></i> Add Room</button></a>
                                <a href="{{ route('owner-create-bed', ['id' => $data['hostel']->id]) }}"><button type="button"
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                @foreach ($data['hostel']->hostel_images as $key => $image)
                                                    <div
                                                        ...
                                                        <img src="{{ $image }}" class="d-block img-fluid w-100"
                                                            height="400px" alt="...">
                                                        <div class="position-absolute top-0 end-0 p-2">
                                                            <form
                                                                action="{{ route('owner-delete-hostel-image', ['id' => $data['hostel']->id]) }}"
                                                                method="post">
                                                                @csrf
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th scope="col" style="width: 30% !important">Other
                                                                    Details</th>
                                                                <th scope="col" style="width: 30% !important">Booking
                                                                    Details</th>
                                                        ...
                                                        <tbody>
                                                            @foreach ($data['booking'] as $key => $student)
                                                                <tr style="height: 100px;">
                                                                    <th scope="row">{{ ++$key }}</th>
                                                                    <td><img src="{{ getImage($student->user->id, $student->user->image) }}"
                                                ...
                                                <tbody>
                                                    @foreach ($data['hostel']->room as $key => $room)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{-- <a
                                                                    href="{{ route('owner-show-room', ['id' => $room->id]) }}">
                                                                    <button type="button" class="btn btn-success me-2"><i
                                                                            class="bi bi-eye"></i></button>
                                                                </a> --}}
                                                                <a
                                                                    href="{{ route('owner-edit-room', ['id' => $room->id]) }}">
                                                                    <button type="button" class="btn btn-warning me-2"><i
                                                                            class="bi bi-pencil-square"></i></button>
                                                                </a>
                                                                <a
                                                                    href="{{ route('owner-destroy-room', ['id' => $room->id]) }}">
                                                ...
                                                <tbody>
                                                    @foreach ($data['bed'] as $key => $bed)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="{{ route('owner-show-bed', ['id' => $bed->id]) }}">
                                                                    <button type="button" class="btn btn-success me-2"><i
                                                                            class="bi bi-eye"></i></button>
                                                                </a>
                                                                <a
                                                                    href="{{ route('owner-edit-bed', ['id' => $bed->id]) }}">
                                                                    <button type="button" class="btn btn-warning me-2"><i
                                                                            class="bi bi-pencil-square"></i></button>
                                                                </a>
                                                                <a
                                                                    href="{{ route('owner-destroy-bed', ['id' => $bed->id]) }}">
                                                                    <button type="button" class="btn btn-danger me-2"><i
                                                                            class="bi bi-trash"></i></button>
                                                                </a>
                                                            </td>
