                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <div class="social-links mt-2">
                            ...
                            <a href="{{ $user->facebook }}" target="_blank" class="facebook"><i class="bi bi-facebook"></i></a>
                            <a href="{{ $user->instagram }}" target="_blank" class="instagram"><i class="bi bi-instagram"></i></a>
                            <a href="{{ $user->linkedin }}" target="_blank" class="linkedin"><i class="bi bi-linkedin"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="{{ route('owner-update-profile') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <div class="pt-2">
                                                ...
                                                <a href="#" class="btn btn-primary btn-sm"
                                                    title="Upload new profile image" id="upload_pic"><i class="bi bi-upload"></i></a>
                                                <a href="{{ route('owner-delete-profile-image') }}" class="btn btn-danger btn-sm"
                            ...
                            <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form action="{{ route('owner-change-password') }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="new_password_confirmation" class="col-md-4 col-lg-3 col-form-label">Re-enter New
                                            Password</label>
                                        <div class="col-md-8 col-lg-9">
                            ...
                            <tbody>
                                @foreach ($documents as $key => $document)
                                    <tr style="height: 100px;">
                                        ...
                                        <td><a href="{{ $document->document_image_front }}" target="_blank"><img src="{{ $document->document_image_front }}" alt="Document Image Front"
                                                style="max-width: 200px;"></a></td>
                                        <td><a href="{{ $document->document_image_back }}" target="_blank"><img src="{{ $document->document_image_back }}" alt="Document Image Back"
                                                style="max-width: 200px;"></a></td>
                                        <td>
