            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body form-body">
                        ...
                        <form action="{{ route('admin-store-owner') }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation">
                            @csrf
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="file" name="image" class="form-control" id="image" capture="false">
                                </div>
                            </div>
                            ...
                            <div class="col-12 text-center">
                                <button class="btn btn-primary w-50 text-center" type="submit">Add Owner</button>
                            </div>
