                                ...
                                <tbody>
                                    @foreach ($owners as $key => $owner)
                                        <tr style="height: 100px;">
                                            ...
                                            <td class="align-middle">{{ $owner->hostels->count() }}</td>
                                            ...
                                            <td class="text-danger align-middle" style="width: 100px !important">
                                                <a href="{{ route('admin-show-owner', ['id' => $owner->id]) }}">
                                                    <button type="button" class="btn btn-success me-2"><i
                                                            class="bi bi-eye"></i></button>
                                                </a>
                                                <a href="{{ route('admin-edit-owner', ['id' => $owner->id]) }}">
                                                    <button type="button" class="btn btn-warning me-2"><i
                                                            class="bi bi-pencil-square"></i></button>
                                                </a>
                                                <a href="{{ route('admin-destroy-owner', ['id' => $owner->id]) }}" onclick="return confirmDelete()">
