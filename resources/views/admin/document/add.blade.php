...
@section('main-section')
    <div class="pagetitle position-relative">
        ...
        <div class="position-absolute top-0 end-0 p-2">
            <a href="{{ route("admin-show-$role", ['id' => $user->id]) }}" class="btn btn-outline-dark">View
                {{ ucfirst($role) }}</a>
        </div>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body form-body">
                        ...
                        <form action="{{ route('admin-store-document', ['id' => $user['id']]) }}" method="POST"
                    ...
                    <div class="card">
                        <div class="card-body form-body">
                            ...
                            @foreach ($documents as $document)
                                <form action="{{ route('admin-update-document', ['id' => $document->id]) }}" method="POST"
                                    enctype="multipart/form-data" class="g-3 needs-validation" novalidate>
                                    @csrf
