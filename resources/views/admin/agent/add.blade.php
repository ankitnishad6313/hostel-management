    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add an Agent</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body form-body">
                        ...
                        <div class="pt-4 pb-2">
                            <h5 class="card-title text-center pb-0 fs-4">Enter Agents Details Below</h5>
                            <p class="text-center small">To create an Agent Acount</p>
                        </div>

                        <form action="{{ route('admin-store-agent') }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation">
                            @csrf
