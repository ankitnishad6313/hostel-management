    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Boarding Students</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Boarding Students</h5>
                                ...
                                <tbody>
                                    @foreach ($students as $key => $student)
                                        <tr style="height: 100px;">
                                            <th scope="row">{{ ++$key }}</th>
                                            <td><img src="{{ getImage($student->id, $student->image) }}" height="80px"
                                                    width="80px" alt="">
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle">
                                                <span class="d-flex fw-bold">{{ $student->hostel_name }}</span>
                                                <span class="d-flex fw-bold">Check In: {{ $student->check_in_date }}</span>
                                                <span class="d-flex fw-bold">Check Out: {{ $student->check_out_date }}</span>
                                                @if ($student->booking_status == 'booked')
                                                    <span class="badge bg-success">
                                                        <i class="bi bi-check-circle me-1"></i>
                                                        Onboarding
                                                    </span>
                                                @elseif ($student->booking_status == 'pending')
                                            ...
                                            <td class="text-danger align-middle" style="width: 100px !important">
                                                ...
                                                <a href="{{ route('admin-destroy-student', ['id' => $student->id]) }}"
