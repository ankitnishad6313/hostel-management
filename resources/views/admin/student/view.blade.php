...
@section('main-section')
    <div class="pagetitle d-flex flex-wrap justify-content-between">
        ...
        <div>
            <a href="{{ route('admin-edit-student', ['id' => $user->id]) }}" class="btn btn-sm btn-outline-dark">Edit Student</a>
                                        ...
                                        <section class="section profile">
                                            <div class="card">
                                                <div
                                                    ...
                                                    <img src="{{ getImage($user->id, $user->image) }}" alt="Profile"
                            ...
                            <div class="tab-pane fade" id="documents-justified" role="tabpanel"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            <h3 class="text-center">Aadhar No. {{ $user->aadhar_no }}</h3>
                                            <div class="col-12 col-lg-6"><img src="{{ $user->aadhar_front }}"
                                                    alt="" class="img-fluid h-100 document-img"></div>
                                            <div class="col-12 col-lg-6"><img src="{{ $user->aadhar_back }}"
                                                    alt="" class="img-fluid h-100 document-img"></div>
                                        </div>
                                    </div> <!-- End Hostel -->
                                </div><!-- End Tabs -->
