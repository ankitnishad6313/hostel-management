...
@section('main-section')
    <div class="pagetitle position-relative">
        ...
        <div class="position-absolute top-0 end-0 p-2">
            <a href="{{ route('agent-profile') }}" class="btn btn-outline-dark">Profile</a>
        </div>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body form-body">
                        ...
                        <form action="{{ route('agent-store-document', ['id' => $user['id']]) }}" method="POST"
                                ...
                                <div id="fieldsContainer">
                                    <div class="row fields-row mb-4">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <div class="input-group has-validation">
                                                <span class="input-group-text" id="inputGroupPrepend"><i
                                                        class="bi card-checklist"></i></span>
                    ...
                    <div class="card">
                        <div class="card-body form-body">
                            ...
                            @foreach ($documents as $document)
                                <form action="{{ route('agent-update-document', ['id' => $document->id]) }}" method="POST"
                                    enctype="multipart/form-data" class="g-3 needs-validation" novalidate>
                                    @csrf
