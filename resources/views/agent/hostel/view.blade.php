            ...
            <div class="col-lg-12 ">
                <div class="card position-relative">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                @foreach ($data['hostel']->hostel_images as $key => $image)
                                                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                                        <img src="{{ $image }}" class="d-block w-100" height="400px"
                                                            alt="...">
                                                    </div>
                                                @endforeach
                                            </div>
                                ...
                                @empty(!$data['hostel']->hostel_features)
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">A desirable or useful feature or facility of a hostel and places.</p>
                                            <ul>
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-bordered" id="borderedTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="coachings-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="coachings" aria-selected="false">Coaching Centers</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="shopping_malls-tab" data-bs-toggle="tab"
                                                    data-bs-target="#bordered-shopping_malls" type="button" role="tab"
                                                    aria-controls="shopping_malls" aria-selected="false">Shopping Malls</button>
                                            </li>
                                        </ul>
                                        <div class="tab-content pt-2" id="borderedTabContent">
                                            <div class="tab-pane fade show active" id="bordered-restaurants" role="tabpanel"
                                        ...
                                        <section class="section profile">
                                            <div class="card">
                                                <div
                                                    ...
                                                    <img src="{{ getImage($data['hostel']->user->image) }}"
                                                    ...
                                                    <table class="table datatable">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th scope="col" style="width: 30% !important">Other
                                                                    Details</th>
                                                        ...
                                                        <tbody>
                                                            @foreach ($data['booking'] as $key => $student)
                                                                <tr style="height: 100px;">
                                                                    <th scope="row">{{ ++$key }}</th>
                                                                    <td><img src="{{ getImage($student->user->image) }}"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <span class="d-flex">Mother Name :
                                                                            {{ $student->user->mother_name }}</span>
                                                                        <span class="d-flex">Father Name :
                                                                            {{ $student->user->father_name }}</span>
                                                                    </td>
                                                                    <td>
                                                                        <span class="d-flex">Email :
                                                                            {{ $student->user->email }}</span>
                                                                        <span class="d-flex">Phone :
                                                                            {{ $student->user->phone }}</span>
                                                                        <span class="d-flex">Address :
                                                                            {{ $student->user->address }}</span>
                                                                    </td>
                                                                    <td class="align-middle">{{ $student->user->gender }}
                                                                    </td>
                                                ...
                                                <tbody>
                                                    @foreach ($data['bed'] as $key => $bed)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h5>
                                                                    @if ($bed->room->bed_type == 1)
                                                                        <span class="badge bg-success">Single Bed</span>
                                                                    @elseif ($bed->room->bed_type == 2)
                                                                        <span class="badge bg-info">Double Bed</span>
                                                                    @else
                                                                        <span class="badge bg-primary">Triple Bed</span>
                                                                    @endif
                    ...
                    {{-- <div class="position-absolute top-0 end-0 pe-3 pt-3">
                        <a href="{{ route('admin-create-room', ['id' => $data['hostel']->id]) }}"><button type="button"
                                class="btn btn-outline-primary"><i class="bi bi-star me-1"></i> Add Room</button></a>
                        <a href="{{ route('admin-create-bed', ['id' => $data['hostel']->id]) }}"><button type="button"
                                class="btn btn-outline-info"><i class="bi bi-star me-1"></i> Add Bed</button></a>
                    </div> --}}
                </div>
            </div>
        </div>
