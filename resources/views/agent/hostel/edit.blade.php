            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body form-body">
                        ...
                        <form action="{{ route('agent-update-hostel', ['id' => $data['hostel']->id] ) }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group has-validation">
                                    <select name="property_type" id="property_type" class="form-control" required>
                                        <option value="hostel" {{ ($data['hostel']->property_type == 'hostel') ? "selected" : ""  }}>Hostel</option>
                                        <option value="pg" {{ ($data['hostel']->property_type == 'pg') ? "selected" : ""  }}>PG</option>
                                    </select>
                                ...
                                <div class="input-group has-validation">
                                    <select name="user_id" id="user_id" class="form-control" required>
                                        @foreach ($data['users'] as $user)
                                            <option value="{{ $user->id }}" {{ ($data['hostel']->user_id == $user->id) ? "selected" : ""  }}>
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group has-validation">
                                    <select name="gender_type" id="gender_type" class="form-control" required>
                                        <option value="boys" {{ ($data['hostel']->gender_type == "Boys") ? "selected" : ""  }}>Boys</option>
                                        <option value="girls" {{ ($data['hostel']->gender_type == "Girls") ? "selected" : ""  }}>Girls</option>
                                        <option value="common" {{ ($data['hostel']->gender_type == "Common") ? "selected" : ""  }}>Common</option>
                                    </select>
                            ...
                            <div class="col-6">
                                <label for="hostel_images" class="form-label fw-bold">Hostel Images <small>(multiple)</small></label>
                                <div class="input-group has-validation">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group has-validation">
                                    <input type="text" name="hostel_address" value="{{ $data['hostel']->hostel_address }}"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <input type="checkbox" class="form-check-input" name="hostel_features[]" value="{{ $feature->features }}" {{ checkFeature($data['hostel']->hostel_features, $feature->features) }}>
